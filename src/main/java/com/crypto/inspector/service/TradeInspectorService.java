...
public class TradeInspectorService {
    ...
    public Map<String,Object> copyToProvenAnalysis(long sellId) {
        ...
        // FIX-122: preserve actual Production evaluations with the copied Proven position.
        com.crypto.execution.service.Fix122ProvenSnapshot.capture(jdbcTemplate,pid,null,sell.getSymbol(),start,end);
