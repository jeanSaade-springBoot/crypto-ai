...
class ExecutionIntelligenceServiceTest {
    ...
    void setUp() {
     ...
     // Test default only: many ExecutionIntelligenceService paths do not consult

     // opportunity persistence. Keep the default empty result available for paths

     // that do, without making unrelated focused tests fail strict Mockito validation.

     lenient().when(opportunityRepository
    ...
    void executionPriceRevalidationUsesFreshPriceNotDecisionSnapshot() {
        ...
        signal.setAtrAtSignal(new BigDecimal("0.50"));var approved = ExecutionIntelligenceService.ExecutionDecision.allow(
    ...
    void atrRetracementDoesNotExecuteWhenNewBearishOneHourAppearsAfterOrigin() {
        ...
        TradeSignal newBearishHour = signal(263L, "ETHUSDT", "1h", SignalDecision.STRONG_SELL, SignalDecision.STRONG_SELL,
                ...
                now.minusSeconds(60), 15, 68);when(signalRepository.findTopBySymbolAndIntervalAndGeneratedAtLessThanEqualOrderByGeneratedAtDesc(
